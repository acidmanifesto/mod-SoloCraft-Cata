...
class SolocraftCataConfig : public WorldScript
{
public:
    SolocraftCataConfig() : WorldScript("SolocraftCataConfig") {}
...
public:
    ...
    void OnLogin(Player* Player, bool /*firstLogin*/) override
    {
        ...
        if (sConfigMgr->GetBoolDefault("Solocraft.Enable", true))
        {
            ...
            {
                ChatHandler(Player->GetSession()).SendSysMessage("This server is running the |cff00ccffFirelands Solocraft Cata |rmodule.");
            }
        }
    }
...
void AddSolocraftCataScripts()
{
    new SolocraftCataConfig();
